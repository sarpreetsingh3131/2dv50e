...
from machine_learner.tasks import classification, regression
...
def save_data(data):
    ...
    file_data.append({
        'packetLoss': data['packetLoss'], 'enerygyConsumption': data['energyConsumption'],
        'classification': data['classification'], 'regression': data['regression']
    })
